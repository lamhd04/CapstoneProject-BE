...
namespace CapstoneProject_BE.Migrations
{
    ...
    [Migration("20230218125747_updateImportv1")]
    partial class updateImportv1
    {
            ...
            modelBuilder.Entity("CapstoneProject_BE.Models.ImportOrderDetail", b =>
                {
                    ...
                    b.HasOne("CapstoneProject_BE.Models.MeasuredUnit", "MeasuredUnit")
                        .WithOne("ImportOrderDetail")
                        .HasForeignKey("CapstoneProject_BE.Models.ImportOrderDetail", "MeasuredUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
